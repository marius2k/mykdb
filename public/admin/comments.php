    ...
    const table = $('#commentsTable').DataTable({
        ...
        columns: [
            ...
            { data: 'article_title', render: function(data, type, row) {
                return `<a href="../view_article.php?id=${row.article_id}">${$('<div>').text(data).html()}</a>`;
            }},
                ...
                `<div style="display:flex;align-items:center;gap:12px;">
                    <div>
                        <div style="font-size:0.8em;"><?=lang('lang_user') ?>:
                            ...
                            <a href="../view_article.php?id=${data.comment.article_id} target="_blank">${data.comment.article_title}</a> | 
