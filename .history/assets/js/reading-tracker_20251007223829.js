...
class ReadingTimeTracker {
    constructor(articleId, appUrl = '', viewSource = 'public') {
    ...
    async saveReadingTime(isFinal = false) {
        ...
        const data = {
            ...
            view_source: this.viewSource
        };
        
        try {
            // Folosește APP_URL pentru API call
            const apiUrl = this.appUrl + 'public/api/bkd_article_reading_analytics.php?action=save_reading_time';
