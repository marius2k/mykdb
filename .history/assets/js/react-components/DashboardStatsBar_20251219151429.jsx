...
const DashboardStatsBar = ({ stats, activities }) => {
    ...
    return React.createElement('div', { className: 'dashboard-stats-bar' },
        // Quick Stats Cards
        React.createElement('div', { className: 'quick-stats-container' },
            // Total Articles Card
        ...
        React.createElement('div', { className: 'activity-feed-container' },
