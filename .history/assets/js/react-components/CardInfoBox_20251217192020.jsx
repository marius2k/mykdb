 ...
 * - defaultOpen: Whether the card is open by default (default: false)
 * - width: Optional width (applies to both open and closed states)
 * - height: Optional height when box is closed (doesn't apply when open)
 * - titleSize: Optional font size for title (e.g., '1.2em', '16px', '1rem')
 * - titleWeight: Optional font weight for title (e.g., 400, 500, 600, 700, 'bold')
 * - backgroundColor: Optional background color for the box (default: 'white')
 */
...
const CardInfoBox = ({ 
    ...
    // Apply width always, height only when closed
    const cardStyle = {
        ...style,
        backgroundColor,
        ...(width && { width }),
    ...
    return (
        ...
        >
            ...
            <div className="card-info-top">
                ...
                <div className="card-info-title" style={titleStyle}>
                    {title}
                </div>
                {collapsible && (
                    <button 
