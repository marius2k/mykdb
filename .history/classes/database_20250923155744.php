...
class Database {
    ...
    /**
     * Execută o interogare SQL și returnează un singur rând
     * @param string $sql Interogarea SQL
     * @param array $params Parametrii pentru interogare
     * @return array|false Rândul rezultat sau false în caz de eroare
     */
    ...
    public function insert($table, $data) {
        ...
        try {
            ...
            error_log("Database::insert - Insert failed: " . $e->getMessage());
            error_log("Database::insert - SQL: " . $sql);
            error_log("Database::insert - Data: " . json_encode($data));
