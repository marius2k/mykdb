            ...
            <div class="search-form">
                   ...
                   <div id="advancedSearchForm" style="display: none; padding: 20px; background-color: white;">
                          <div style="display: flex; flex-direction: column; align-items: center; gap: 12px; max-width: 400px; margin: 0 auto;">
                            <!-- Search Text Field -->
                            <label for="liveSearch" style="text-align: center; width: 100%;"><?= lang('lang_text') ?></label>
                            <input type="text" id="liveSearch" placeholder="<?= lang('lang_search_placeholder') ?>" autocomplete="off" style="width: 100%;">
                            </div>
                    </div>
            </div>
