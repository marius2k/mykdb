                    ...
                    echo '<div class="reading-progress-widget">
                            <div class="progress-circle-container">
                                <svg class="progress-ring" width="100" height="100" viewBox="0 0 100 100">
                                    <circle class="progress-ring-circle-bg" stroke="#e0e0e0" stroke-width="8" fill="transparent" r="42" cx="50" cy="50"/>
                                    <circle class="progress-ring-circle" stroke="var(--primary-color, #4e73df)" stroke-width="8" fill="transparent" r="42" cx="50" cy="50" 
                                        style="stroke-dasharray: 263.89; stroke-dashoffset: ' . (263.89 - (263.89 * $progress['percentage'] / 100)) . ';"/>
                                </svg>
