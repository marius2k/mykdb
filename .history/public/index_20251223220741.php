                    ...
                    echo '<div class="reading-progress-widget">
                            <div class="progress-circle-container">
                                <svg class="progress-ring" width="160" height="160" viewBox="0 0 160 160">
                                    <circle class="progress-ring-circle-bg" stroke="#e0e0e0" stroke-width="10" fill="transparent" r="70" cx="80" cy="80"/>
                                    <circle class="progress-ring-circle" stroke="var(--primary-color, #4e73df)" stroke-width="10" fill="transparent" r="70" cx="80" cy="80" 
                                        style="stroke-dasharray: 439.82; stroke-dashoffset: ' . (439.82 - (439.82 * $progress['percentage'] / 100)) . ';"/>
                                </svg>
