...
<div class="breadcrumb-filter-section" style="display: flex; justify-content: space-between; align-items: center; width: 100vw; padding: 6px 20px; margin-top: 0; margin-bottom: 0; margin-left: calc(-50vw + 50%);">
    ...
    <div style="display: flex; align-items: center; margin-right: 20px; color: #666; font-size: 14px;">
        <?php if ($lastLogin): ?>
            <span><?= lang('lang_last_login') ?>: <strong><?= date('Y-m-d H:i', strtotime($lastLogin)) ?></strong></span>
        <?php endif; ?>
    </div>
</div>
<style>
