    ...
    <div style="width: 50%; overflow: hidden; margin-left: 20px; color: #666; font-size: 14px;">
        <div style="display: inline-block; white-space: nowrap; animation: scroll-left 30s linear infinite;">
            <span>
                ...
                <span style="color: #029affff; padding-right: 10px;"><?= lang('lang_approved') ?>: <?= $approvedCount ?> </span> 
                <span style="color: #04709bcc; padding-right: 10px;">Total Articles:<?= $db->query("SELECT COUNT(*) FROM articles")->fetchColumn() ?> </span> 
                <span style="color: #04709bcc; padding-right: 10px;">Total Users: <?= $db->query("SELECT COUNT(*) FROM users")->fetchColumn() ?> </span> 
