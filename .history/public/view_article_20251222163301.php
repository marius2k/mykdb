...
// Note: Article view tracking is done below after article is loaded and validated
// This ensures we only track views for valid, accessible articles
...
try {
    ...
    */
    ...
    // Track article view for logged-in users (only for online/published articles)
    if ($userId && $isOnline == 1) {
        try {
