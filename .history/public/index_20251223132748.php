...
window.formatWithIcon = function(option) {
  console.log('formatWithIcon called with:', option); // Debug
  ...
  let text = (option.text || '').trim(); // TRIM WHITESPACE!
  ...
  console.log('Truncated text:', option.text.trim(), '→', text); // Debug
    ...
    setTimeout(() => {
        ...
        $select.select2({
            ...
            templateResult: function(data) {
                console.log('templateResult called:', data);
                return window.formatWithIcon(data);
            },
            templateSelection: function(data) {
                console.log('templateSelection called:', data);
                return window.formatWithIcon(data);
            }
        });
        $select.on('change', triggerAdvancedSearch);
        
        // Force Select2 to re-render by triggering change
        $select.trigger('change.select2');
        
        console.log('Select2 initialized, version:', $.fn.select2.defaults.amdBase); // Debug
    }, 200);
