...
<!-- Link to React component styles -->
...
<div class="container" style="max-width: 1200px; margin: 0 auto; padding: 20px;">
    ...
    <div class="code-explanation" style="margin-top: 40px; padding: 20px; background: #f5f5f5; border-radius: 8px;">
        ...
        <ol>
            ...
            <li><strong>Styles:</strong> <code>assets/css/react-components.css</code></li>
        </ol>
...
<script type="text/babel" src="<?= APP_URL ?>assets/js/react-components/DashboardStats.jsx"></script>
