                ...
                if ($progress['message']) {
                    ...
                    echo '<div class="reading-progress-widget">
                            <div class="progress-circle-container">
                                <svg class="progress-ring" width="180" height="180" viewBox="0 0 180 180">
                                    ...
                                    <circle class="progress-ring-circle" stroke="var(--primary-color, #4e73df)" stroke-width="12" fill="transparent" r="78" cx="90" cy="90" 
                                        style="stroke-dasharray: 490.09; stroke-dashoffset: ' . (490.09 - (490.09 * $progress['percentage'] / 100)) . ';"/>
                                </svg>
                            ...
                            <div class="progress-stats">
                                <div class="stat-row">
                                    <div class="stat-item">
                                        <span class="stat-value">' . $progress['articles_read'] . '</span>
                                        <span class="stat-label">' . lang('lang_articles_completed') . '</span>
                                    </div>
                                    <div class="stat-item">
                                ...
                                <div class="progress-total">' . $progress['total_articles'] . ' total articles</div>
                            </div>
                          </div>';
                }
            ?>
