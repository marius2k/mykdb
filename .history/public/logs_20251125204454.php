...
<div style="background-color: #e8f4f8; display: flex; justify-content: space-between; align-items: center; width: 100vw; padding: 15px 20px; margin-top: 0; margin-bottom: 0; margin-left: calc(-50vw + 50%); border-bottom: 2px solid #b0d4e3;">
