                ...
                <!-- Filter form -->
                  <div id="advancedFilterForm" style="display: none; padding: 20px; background-color: white;">
                    ...
                    <form id="filterOnCategory" width="100%">
                        <div style="display: flex; flex-direction: column; align-items: center; gap: 12px; max-width: 400px; margin: 0 auto;">
                            <!-- Author Filter -->
                            <label for="searchAuthor" style="text-align: center; width: 100%;"><?= lang('lang_art_author') ?>:</label>
                            <input type="text" id="searchAuthor" name="author" style="width: 100%;">

                            <!-- Category Filter -->
                            <label for="filterCategory" style="text-align: center; width: 100%;"><?= lang('lang_art_category') ?>:</label>
