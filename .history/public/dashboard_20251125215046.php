...
// Drafts this week
$draftsStmt = $db->query("SELECT COUNT(*) FROM articles WHERE status = 'draft' AND created_at >= ?", [$weekStart]);
$draftsCount = $draftsStmt->fetchColumn();

// Pending this week
$pendingStmt = $db->query("SELECT COUNT(*) FROM articles WHERE status = 'pending' AND created_at >= ?", [$weekStart]);
$pendingCount = $pendingStmt->fetchColumn();

// Approved this week (assuming approved means published with approved_at date)
$approvedStmt = $db->query("SELECT COUNT(*) FROM articles WHERE status = 'published' AND approved_at >= ? AND approved_at IS NOT NULL", [$weekStart]);
