...
<div class="breadcrumb-filter-section" style="display: flex; justify-content: space-between; align-items: center; width: 100vw; padding: 6px 20px; margin-top: 0; margin-bottom: 0; margin-left: calc(-50vw + 50%);">
    <div style="width: 50%; overflow: hidden; margin-left: 20px; color: #666; font-size: 14px;">
        <div style="display: inline-block; white-space: nowrap; animation: scroll-left 30s linear infinite;">
            <span><strong style="color: #04709bcc"><?= lang('lang_articles_this_month') ?>:</strong> 
                <span style="color: #770286ff"><?= lang('lang_published') ?>: <?= $publishedCount ?> </span>  
                <span style="color: #d60303ff"><?= lang('lang_drafts') ?>: <?= $draftsCount ?> </span> 
                <span style="color: #02860dff"><?= lang('lang_pending') ?>: <?= $pendingCount ?> </span> 
                <span style="color: #029affff; padding-right: 10px;"><?= lang('lang_approved') ?>: <?= $approvedCount ?> </span> 
                <span style="color: #04709bcc; padding-right: 10px;"><strong>Total Articles:</strong><?= $db->query("SELECT COUNT(*) FROM articles")->fetchColumn() ?> </span> 
                <span style="color: #04709bcc; padding-right: 10px;"><strong>Total Users:</strong> <?= $db->query("SELECT COUNT(*) FROM users")->fetchColumn() ?> </span> 
                <span style="color: #04709bcc"><strong>Online Users:</strong> <?= $onlineUsersCount ?></span>
            </span>
