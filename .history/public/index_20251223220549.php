                    ...
                    echo '<div class="reading-progress-widget">
                            <div class="progress-circle-container">
                                <svg class="progress-ring" width="140" height="140" viewBox="0 0 140 140">
                                    ...
                                    <circle class="progress-ring-circle" stroke="var(--primary-color, #4e73df)" stroke-width="10" fill="transparent" r="60" cx="70" cy="70" 
                                        style="stroke-dasharray: 376.99; stroke-dashoffset: ' . (376.99 - (376.99 * $progress['percentage'] / 100)) . ';"/>
                                </svg>
