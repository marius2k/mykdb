                    ...
                    echo '<div class="reading-progress-widget">
                            <div class="progress-circle-container">
                                <svg class="progress-ring" width="120" height="120">
                                    ...
                                    <circle class="progress-ring-circle" stroke="var(--primary-color, #4e73df)" stroke-width="8" fill="transparent" r="52" cx="60" cy="60" 
                                        style="stroke-dasharray: 326.73; stroke-dashoffset: ' . (326.73 - (326.73 * $progress['percentage'] / 100)) . ';"/>
                                    <text x="60" y="60" text-anchor="middle" dy="0.3em" class="progress-percentage">' . $progress['percentage'] . '%</text>
                                </svg>
                            </div>
                            <div class="progress-stats">
                                <div class="stat-item">
                                    <span class="stat-value">' . $progress['articles_read'] . '</span>
                                    <span class="stat-label">' . lang('lang_of') . ' ' . $progress['total_articles'] . ' ' . lang('lang_articles_completed') . '</span>
                                </div>
                            </div>
                          </div>';
                }
