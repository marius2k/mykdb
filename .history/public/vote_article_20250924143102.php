...
// send notification
$uid = getArticleAuthorId($aid,'articles');
sendNotificationToUser($uid, 'Article voted','Your <a href="view_article.php?id='.$aid.'">article</a> has been voted with: '. $vote,'info');
