    ...
    async function checkTranslationServiceStatus() {
        ...
        try {
            ...
            const response = await fetch('<?= APP_URL ?>public/api/translate_article.php', {
                ...
                body: JSON.stringify({ article_id: articleId, target_lang: 'test' })
            });
            ...
            if (response.status === 503) {
                ...
                // Service is ready (400 = bad request means service responded)
       ...
       <div class="article-view" style="max-width:80%; margin:20px auto;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <span id="translation-status" style="font-size: 0.85rem; color: #888;"></span>
