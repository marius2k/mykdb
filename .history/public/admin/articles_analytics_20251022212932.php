...
function displayWeeklyStats(stats) {
    ...
    container.innerHTML = `
        <div class="stat-card views">
            ...
            <div class="stat-sublabel" style="font-size: 0.9em; color: #95a5a6; margin-top: 2px; margin-left: 10px;">
        ...
        <div class="stat-card reading">
            ...
            <div class="stat-sublabel" style="font-size: 0.8em; color: #95a5a6; margin-top: 2px; margin-left: 10px;">
