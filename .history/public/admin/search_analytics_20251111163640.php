...
function displayUserSearchStats(userStats) {
    ...
    let html = `
        <table id="user-search-stats-table" class="data-table" style="width:100%">
            <thead>
                <tr>
                    <th>User</th>
                    <th>Role</th>
    ...
    $('#user-search-stats-table').DataTable({
        ...
        columnDefs: [
            { orderable: false, targets: [1] }, // Disable sorting on Role column (has HTML badges)
            { type: 'num', targets: [2, 3, 4, 5, 6] } // Numeric sorting for stats columns
        ]
    });
}
// Helper functions
