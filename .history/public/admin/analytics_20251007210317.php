...
function displayTopArticlesTable(articles) {
    ...
    articles.forEach(article => {
        ...
        row.innerHTML = `
            <td>${article.id}</td>
            <td><a href="#" onclick="loadArticleDetailsByClick(${article.id}); return false;" style="color: #3498db; text-decoration: none; cursor: pointer;" title="Click to view analytics">${truncateText(article.title, 50)}</a></td>
