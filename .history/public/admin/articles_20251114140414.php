...
function generateActionsForArticleWithVersionData(articleId, versionData, rowData) {
    return buildActionsHtml(articleId, versionData.status, rowData.publish_at || '', versionData.version_number, rowData.user_id || 0, rowData.current_version || null, rowData.article_status || null);
}
