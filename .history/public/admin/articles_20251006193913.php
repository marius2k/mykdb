        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) { 
                    ...
                    if (isOnlineVersion) {
                        return `${title}&nbsp;&nbsp;&nbsp;<span class="online-label" style="background: #2ecc71; color: white; padding: 2px 6px; border-radius: 3px; font-size: 0.75em; font-weight: bold;">ONLINE</span>`;
                    } else {
                        return title;
                    }
                } 
