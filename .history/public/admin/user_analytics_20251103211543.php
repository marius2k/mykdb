...
async function loadSearchBehaviorData() {
    try {
        ...
        const processedData = processSearchBehaviorData(data);
        
        // Update summary metrics
        displaySearchMetrics(processedData.metrics);
        
        // Display top search queries
        displayTopSearchQueries(processedData.topQueries);
        
        // Display most clicked articles from search
        displayClickedArticlesFromSearch(processedData.topClickedArticles);
        
        // Display recent search activity
        displayRecentSearchActivity(processedData.recentActivity);
        
        console.log('Search behavior data displayed successfully');
