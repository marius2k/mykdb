...
/* Override articles-table styling for DataTables to match User Analytics */
table.dataTable thead {
    background-color: #2196F3 !important;
    background: linear-gradient(to bottom, rgba(0,0,0,0.02) 0%, rgba(0,0,0,0.02) 100%), #2196F3 !important;
}
...
function updateTopSearches(searches) {
    ...
    let html = `
        <table class="articles-table" style="font-size: 0.85em; width:100%">
            <thead>
                <tr>
                    <th>Query</th>
