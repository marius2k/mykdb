...
if (isset($_GET['approve'])) {
    ...
    sendNotificationToUser($authorId, 'Article Approved','Your article <a href="article.php?id='.$articleId.'">'. truncateText($article['title'],30). '</a> has been approved.','info');
    header("Location: articles.php");
    exit;
                        ...
                        <div style="display: flex; flex-direction: column; gap: 10px;">
                                ...
                                <div style="display: flex; flex-direction: column; gap: 10px;">
                                        ...
                                        <div class="form-group" style="display: flex; flex-direction: row;">
                                            ...
                                            <select name="category_id" id="add_category_select" class="select2-icon" style="width:70%" placeholder="<?=lang('lang_cat_select') ?>" required>
                                ...
                                <td align="center">
                                    ...
                                    <?php if ($a['status'] == 'pending'): ?>
                                        ...
                                        <?php
                                            ...
                                            if (hasPermission($_SESSION['user']['id'],$op)){
                                        ?>
                                        <a href="?approve=<?= $a['id'] ?>&publish_at=<?=$a['publish_at']?>" ><img src="<?=APP_URL?>assets/icons/icon-approve.svg" class="op-icon" title="<?= lang('lang_btn_approve') ?>"></a>
                                        <?php } ?>
                                    ...
                                    <?php else: ?>
                                        <?php
                                            ...
                                            if (hasPermission($_SESSION['user']['id'],$op)){
                                        ?>
                                        <a href="?disable=<?= $a['id'] ?>" onclick="updateStatus(<?= $a['id'] ?>)"><img src="<?=APP_URL?>assets/icons/icon-disable.svg" class="op-icon" title="<?= lang('lang_btn_disable') ?>"></a>
