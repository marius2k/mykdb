...
<div class="analytics-container">
    ...
    <!-- Period Selector -->
    <div style="display: flex; align-items: right; gap: 10px; margin-bottom: 20px;">
...
function displayWeeklyStats(stats, period = '7') {
    ...
    container.innerHTML = `
        <div class="stat-card views">
            ...
            <div class="stat-label">${TRANSLATIONS.public_views} (${periodLabel})</div>
        ...
        <div class="stat-card likes">
            ...
            <div class="stat-label">${TRANSLATIONS.likes} (${periodLabel})</div>
        </div>
        ...
        <div class="stat-card engagement">
            ...
            <div class="stat-label">${TRANSLATIONS.reading_sessions} (${periodLabel})</div>
            <div class="stat-sublabel" style="font-size: 1em; color: #95a5a6; margin-top: 2px; margin-left: 10px;">
