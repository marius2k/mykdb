...
<div class="container" style="max-width: 1400px; margin: 0 auto;">
    ...
    <div class="tab-content active" id="analytics-content">
        ...
        <div class="analytics-grid">
            ...
            <div class="widget">
                <h3><img src="<?=APP_URL?>assets/icons/icon-search-no-results.svg" width="40">&nbsp;&nbsp;Searches with No Results</h3>
            ...
            <!-- Click-Through Rates -->
            <div class="widget">
                <h3><img src="<?=APP_URL?>assets/icons/icon-search-click-rates.svg" width="40">&nbsp;&nbsp;Click-Through Rates</h3>
            ...
            <div class="widget">
                <h3><img src="<?=APP_URL?>assets/icons/icon-search-most-clicked.svg" width="40">&nbsp;&nbsp;Most Clicked Articles from Search</h3>
                <div id="clicked-articles-container">Loading...</div>
            </div>
            
            <!-- Click Position Distribution -->
            <div class="widget">
                <h3><img src="<?=APP_URL?>assets/icons/icon-search-click-position.svg" width="40">&nbsp;&nbsp;Click Position Distribution</h3>
