...
<div style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-top: 20px; margin-bottom: 10px;">
    ...
    <!-- Filter on the right -->
    <div id="users-filters" style="border: 1px solid #ccc; border-radius: 8px; padding: 10px 15px; background-color: #f8f9fa;">
...
function renderUserFilters() {
    let html = `<div style="display: flex; gap: 10px; align-items: center;">
            ...
            <select id="filterRole" name="role" style="padding: 5px 10px; border: 1px solid #ccc; border-radius: 4px;">
