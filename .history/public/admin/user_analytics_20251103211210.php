...
<div class="analytics-container" >
    ...
    <div class="tab-content" id="content-interaction-tab">
        ...
        <div class="table-container">
            <h4 style="font-size: 1.5em;"><img src="<?=APP_URL?>assets/icons/icon-search.svg" width="40">&nbsp;&nbsp;Search Behavior</h4>
            <p style="color: #666; margin-bottom: 20px;">User search queries and clicked articles from search results</p>
            
            <table id="searchBehaviorTable" class="articles-table" style="font-size: 0.85em; width:100%">
                <thead>
                    <tr>
                        <th>Date/Time</th>
                        <th>Query</th>
                        <th>Results</th>
                        <th>Clicked Article</th>
                        <th>Position</th>
                    </tr>
                </thead>
                <tbody>
