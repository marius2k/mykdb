...
async function loadContentInteractionData() {
    ...
    try {
        ...
        try {
            ...
            // Use the simplified API for development that returns mock data
            const apiUrl = `<?= APP_URL ?>public/api/bkd_user_analytics_simple.php?action=get_user_analytics&start_date=${startDate}&end_date=${endDate}`;
