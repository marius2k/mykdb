...
<div class="analytics-container" >
    ...
    <div style="display: flex; align-items: flex-end; border-bottom: 1px solid #dee2e6; margin-bottom: 20px;">
        ...
        <!-- Filter Section -->
        <div class="filter-section" style="display: flex; gap: 0px; align-items: center; margin-bottom: 0; margin-left: auto;">
            <div class="form-group" style="white-space: nowrap; margin-bottom: 0; margin-right: 10px; display: flex; align-items: center; gap: 2px;">
