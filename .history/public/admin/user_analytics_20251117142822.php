...
<div class="analytics-container" >
    ...
    <div style="display: flex; align-items: flex-end; border-bottom: 1px solid #dee2e6; margin-bottom: 20px;">
        ...
        <!-- Filter Section -->
        <div class="filter-section" style="display: flex; gap: 10px; align-items: flex-end; margin-bottom: 0; margin-left: auto;">
            <div class="form-group" style="white-space: nowrap; margin-bottom: 0; display: flex; align-items: flex-end; gap: 2px;">
