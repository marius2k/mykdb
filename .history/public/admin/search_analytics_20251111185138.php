...
<div class="container" style="max-width: 1400px; margin: 0 auto;">
    ...
    <div class="section-content active" id="overview-section">
        ...
        <!-- Search Trends Chart -->
        <div class="widget">
            <h4><img src="<?=APP_URL?>assets/icons/icon-search-over-time.svg" width="40">&nbsp;&nbsp;Search Trends Over Time</h4>
        ...
        <div class="widget">
            <h4><img src="<?=APP_URL?>assets/icons/icon-search-over-time.svg" width="40">&nbsp;&nbsp;Search Activity by User</h4>
    ...
    <div class="section-content" id="queries-section">
        <div class="analytics-grid">
            <!-- Top Searches -->
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-top-search.svg" width="40">&nbsp;&nbsp;Top Searches</h4>
                <div id="top-searches-container">Loading...</div>
            </div>
            
            <!-- Zero Results Searches -->
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-no-results.svg" width="40">&nbsp;&nbsp;Searches with No Results</h4>
    ...
    <div class="section-content" id="performance-section">
        <div class="analytics-grid">
            <!-- Click-Through Rates -->
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-click-rates.svg" width="40">&nbsp;&nbsp;Click-Through Rates</h4>
            ...
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-most-clicked.svg" width="40">&nbsp;&nbsp;Most Clicked Articles from Search</h4>
                <div id="clicked-articles-container">Loading...</div>
            </div>
            
            <!-- Click Position Distribution -->
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-click-position.svg" width="40">&nbsp;&nbsp;Click Position Distribution</h4>
    ...
    <div class="section-content" id="user-behavior-section">
        ...
        <div class="analytics-grid">
            ...
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-popular.svg" width="40">&nbsp;&nbsp;Popular Search Queries</h4>
            ...
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-most-clicked.svg" width="40">&nbsp;&nbsp;Articles Found Through Search</h4>
            ...
            <div class="widget">
                <h4><img src="<?=APP_URL?>assets/icons/icon-search-recent.svg" width="40">&nbsp;&nbsp;Recent Search Activity</h4>
...
function initTabs() {
    ...
    sectionTabs.forEach(tab => {
        tab.addEventListener('click', function() {
            ...
            // If switching to overview and we have cached data, re-render charts
            if (currentSection === 'overview' && cachedDashboardData) {
                console.log('Switching to overview, re-rendering charts with cached data');
...
async function loadDashboardData(period = currentPeriod) {
    try {
        ...
        // Update charts (only if overview section is active)
        if (currentSection === 'overview') {
            updateTrendsChart(data.trends);
            updatePositionChart(data.position_stats);
        } else {
            console.log('Charts not rendered - not on overview section');
        }
...
function updateTrendsChart(trends) {
    ...
    if (!trends || trends.length === 0) {
        ...
        if (container) {
            ...
            container.innerHTML = '<div class="no-data">No search data available for this period</div>';
        }
        return;
    }
...
async function loadUserBehaviorData(period = currentPeriod) {
    try {
        ...
        if (data.length > 0) {
            ...
            console.log('Article IDs in data:', data.map(d => d.article_id).filter(id => id));
        }
...
function processUserBehaviorData(data) {
    ...
    // Group by article
    const articleMap = {};
    console.log('Processing articles, checking article_id values...');
    data.forEach((d, index) => {
        if (index < 3) {
            console.log(`Record ${index}:`, {
                article_id: d.article_id,
                type: typeof d.article_id,
                greaterThanZero: d.article_id > 0,
    ...
    console.log('Total articles with clicks:', Object.keys(articleMap).length);
