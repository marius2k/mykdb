...
<div class="analytics-container" >
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 1px solid #dee2e6; margin-bottom: 20px;">
        <!-- Tabs -->
        ...
        <!-- Filter Section -->
        <div class="filter-section" style="display: flex; gap: 10px; align-items: center; margin-bottom: 0; margin-left: auto;">
            <div class="form-group" style="white-space: nowrap; margin-bottom: 0; display: flex; align-items: center; gap: 2px;">
                <label for="role-filter" style="margin-bottom: 0; font-size: 0.9em; text-align: right; color: #6c757d;"><?= lang('lang_analytics_role') ?>:</label>
                <select id="role-filter" class="form-control" style="width: 140px; height: 32px; font-size: 0.9em; padding: 4px 8px;">
            ...
            <div class="form-group" style="white-space: nowrap; margin-bottom: 0; display: flex; align-items: center; gap: 2px;">
                <label for="time-period" style="margin-bottom: 0; font-size: 0.9em; text-align: right; color: #6c757d;"><?= lang('lang_analytics_time_period')?></label>
                <select id="time-period" class="form-control" style="width: 140px; height: 32px; font-size: 0.9em; padding: 4px 8px;">
