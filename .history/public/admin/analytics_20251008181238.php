...
<html>
<head>
    <meta http-equiv="refresh" content="2;url=articles_analytics.php' . (isset($_SERVER['QUERY_STRING']) && !empty($_SERVER['QUERY_STRING']) ? '?' . $_SERVER['QUERY_STRING'] : '') . '">
    <title>Analytics Moved</title>
    <style>
...
<body>
    <div class="container">
        <h1>Analytics Page Has Moved</h1>
        <p>The analytics dashboard has been separated into two parts:</p>
        <ul>
            <li><a href="articles_analytics.php">Article Analytics</a> - For tracking article performance</li>
            <li><a href="user_analytics.php">User Analytics</a> - For tracking user engagement</li>
        </ul>
        <p class="redirect">You will be redirected to Article Analytics in 2 seconds...</p>
    </div>
</body>
</html>';
exit;
