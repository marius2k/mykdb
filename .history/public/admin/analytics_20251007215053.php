...
.stat-card.views { border-left-color: #edfd03c4; }
.stat-card.likes { border-left-color: #e74c3c; }
.stat-card.reading { border-left-color: #07c45cff; }
.stat-card.engagement { border-left-color: #0274c0ff; }
...
function displayWeeklyStats(stats) {
    ...
    container.innerHTML = `
        <div class="stat-card views">
            ...
            <div class="stat-label">👁️ ${TRANSLATIONS.views_this_week}</div>
        </div>
        ...
        <div class="stat-card reading">
            ...
            <div class="stat-label">📚 ${TRANSLATIONS.avg_reading_time}</div>
        </div>
            ...
            datasets: [
                {
                    ...
                    data: viewsData,
                    backgroundColor: 'rgba(2, 165, 70, 0.7)',
                    borderColor: 'rgba(2, 165, 70, 1)',
                    borderWidth: 1
                },
                {
