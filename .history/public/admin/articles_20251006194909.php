...
// Funcție pentru actualizarea label-urilor "ONLINE" în DataTables
        ...
        table.rows().every(function() {
            ...
            if (row && node) {
                ...
                if (titleCell) {
                    ...
                    // Elimină label-ul existent dacă există
                    const existingLabel = titleCell.querySelector('.online-label');
                    if (existingLabel) {
                        existingLabel.remove();
                        // Elimină și spațiile care urmează
                        const nextSibling = existingLabel.nextSibling;
                        if (nextSibling && nextSibling.nodeType === Node.TEXT_NODE) {
                            nextSibling.remove();
                        }
                    }
                    
                    // Adaugă label-ul la început dacă este versiunea online
                    if (isOnlineVersion) {
