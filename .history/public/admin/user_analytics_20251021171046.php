...
<div class="analytics-container" >
    ...
    <div class="tab-content active" id="user-engagement-tab">
        ...
        <div class="chart-container">
            <h4 style="font-size: 0.85em;"><img src="<?=APP_URL?>assets/icons/icon-user-eng-over-time.svg" width="40" >&nbsp;&nbsp;<?= lang('lang_analytics_engagement_over_time') ?></h4>
        ...
        <!-- Engagement by Role -->
        <div class="chart-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-user-eng-by-role.svg" width="40">&nbsp;&nbsp;<?= lang('lang_analytics_engagement_by_role') ?></h4>
    ...
    <div class="tab-content" id="admin-activity-tab">
        ...
        <div class="chart-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-user-eng-admin-activity-over-time.svg" width="40">&nbsp;&nbsp;<?= lang('lang_analytics_admin_activity_over_time') ?></h4>
            <canvas id="adminActivityChart" width="400" height="200"></canvas>
        </div>
        
        <!-- Activity by Admin Table -->
        <div class="table-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-user-eng-admin-activity.svg" width="40">&nbsp;&nbsp;<?= lang('lang_analytics_activity_by_admin') ?></h4>
        ...
        <div class="table-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-user-eng-most-active-articles.svg" width="40">&nbsp;&nbsp;<?= lang('lang_analytics_most_active_articles') ?></h4>
    ...
    <div class="tab-content" id="content-interaction-tab">
        ...
        <!-- User Actions Chart -->
        <div class="chart-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-user-eng-actions-over-time.svg" width="40">&nbsp;&nbsp;<?= lang('lang_analytics_user_actions_over_time') ?></h4>
        ...
        <div class="table-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-user-eng-interactions.svg" width="40">&nbsp;&nbsp;<?= lang('lang_analytics_top_articles_by_interaction') ?></h4>
