...
async function loadDashboardData() {
    try {
        const response = await fetch('/mykdb/public/api/reading_analytics.php?action=get_analytics_dashboard');
...
async function loadTopArticles() {
    ...
    try {
        const response = await fetch(`/mykdb/public/api/reading_analytics.php?action=get_combined_stats&order_by=${sortBy}&limit=${limit}`);
        const data = await response.json();
...
async function loadArticleDetails() {
    ...
    try {
        const response = await fetch(`/mykdb/public/api/reading_analytics.php?action=get_article_analytics&article_id=${articleId}`);
        const data = await response.json();
