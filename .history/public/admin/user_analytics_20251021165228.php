...
<div class="analytics-container" >
    ...
    <div class="tab-content active" id="user-engagement-tab">
        ...
        <div class="chart-container">
            <h4 style="align-items: center; display: flex;"><img src="<?=APP_URL?>assets/icons/icon-user-eng-over-time.svg" width="40" >&nbsp;&nbsp;<?= lang('lang_analytics_engagement_over_time') ?></h4>
            <canvas id="engagementChart" width="400" height="200"></canvas>
        </div>
        
        <!-- Most Engaged Users Table -->
        <div class="table-container">
            <h4><img src="<?=APP_URL?>assets/icons/icon-analytics-detailed.svg" width="40"><?= lang('lang_analytics_most_engaged_users') ?></h4>
