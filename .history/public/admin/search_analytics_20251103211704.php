...
<div class="container" style="max-width: 1400px; margin: 0 auto;">
    ...
    <!-- Section Tabs -->
    <div class="analytics-tabs" style="margin-bottom: 10px;">
    ...
    <!-- Period Tabs -->
    <div class="analytics-tabs" style="border-top: none; padding-top: 0;">
        <div class="tab period-tab active" data-period="7">Last 7 Days</div>
        <div class="tab period-tab" data-period="30">Last 30 Days</div>
        <div class="tab period-tab" data-period="90">Last 90 Days</div>
    </div>
