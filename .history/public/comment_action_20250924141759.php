...
try {
    if ($action === 'approve') {
        ...
        if ($userRole <> 'guest') {
            sendNotificationToUser($userId,$op, $msg, 'info');
        }
        ...
        if ($userRole <> 'guest') {
            sendNotificationToUser($userId,lang('lang_com_op_rejected'), lang('lang_com_rejected'), 'info');
        }
        ...
        if ($userRole <> 'guest') {
            sendNotificationToUser($userId,lang('lang_com_op_deleted'), lang('lang_com_deleted'), 'info');
        }
