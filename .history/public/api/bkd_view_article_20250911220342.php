...
try {
    ...
    // Folosește funcția existentă pentru bookmark-uri
    $isBookmarked = is_article_bookmarked($id, $_SESSION['user']['id'] ?? null);

    // Adaugă datele suplimentare la articol
