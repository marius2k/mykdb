...
function getUserAnalytics($db) {
    ...
    // Update table alias in conditions
    $whereClause = str_replace(['article_id =', 'user_id =', 'action_date '], ['ua.article_id =', 'ua.user_id =', 'ua.action_date '], $whereClause);
    $andClause = str_replace(['article_id =', 'user_id =', 'action_date '], ['ua.article_id =', 'ua.user_id =', 'ua.action_date '], $andClause);
    $whereClause = !empty($whereConditions) ? 'WHERE ' . implode(' AND ', $whereConditions) : '';
    $andClause = !empty($whereConditions) ? 'AND ' . implode(' AND ', $whereConditions) : '';
    ...
    try {
        ...
        try {
            // Bookmarks count
            $bookmarks = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.action_type = 'bookmark' $andClause", $params);
        ...
        try {
            ...
            $usefulnessRatings = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.action_type = 'usefulness_rating' $andClause", $params);
        ...
        try {
            // Average star rating
            $avgRating = $db->fetchSingle("SELECT AVG(CAST(ua.value AS DECIMAL(3,2))) as avg $fromClause WHERE ua.action_type = 'rating' $andClause", $params);
        ...
        try {
            // PDF saves count
            $pdfSaves = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.action_type = 'save_pdf' $andClause", $params);
        ...
        try {
            // Comments count
            $comments = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.action_type = 'comment' $andClause", $params);
        ...
        try {
            // Useful yes count
            $usefulYes = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.action_type = 'usefulness_rating' AND ua.value = 1 $andClause", $params);
        ...
        try {
            // Useful no count
            $usefulNo = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.action_type = 'usefulness_rating' AND ua.value = 0 $andClause", $params);
        ...
        try {
            ...
            try {
                $hasArticles = $db->fetchSingle("SELECT COUNT(*) as count $fromClause WHERE ua.article_id > 0 $andClause", $params);
