    ...
    try {
        ...
        $query = "
            SELECT 
                ...
                u.username,
                u.role,
                COUNT(DISTINCT CASE WHEN aa.action_type IN ('create_article', 'create_version') THEN aa.article_id END) as articles_submitted,
                COUNT(DISTINCT CASE WHEN aa.action_type = 'approve_article' THEN aa.article_id END) as articles_approved,
                COUNT(DISTINCT CASE WHEN aa.action_type = 'publish_article' THEN aa.article_id END) as articles_published,
