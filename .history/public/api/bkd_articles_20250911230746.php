...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['action'])) {
        ...
        try {
            ...
            // Filtered count - count unique articles that match criteria
            ...
            // Main query - get ONE record per article (preferably the online version or latest)
