...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_GET['action'])) {
        ...
        try {
            ...
            error_log("bkd_articles: Total online articles: $totalArticles");
            ...
            error_log("bkd_articles: Found " . count($articles) . " online articles");
            ...
            foreach ($articles as &$a) {
                ...
                error_log("bkd_articles: Processed article ID: " . $a['article_id'] . ", Title: " . $a['title'] . ", Status: " . $a['status'] . ", Version: " . $a['current_version'] . ", Total versions: " . count($a['versions']));
            }
