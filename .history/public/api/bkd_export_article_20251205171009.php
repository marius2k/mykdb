...
if ($created_at) {
    $html .= '<p><strong>Data publicării:</strong> ' . htmlspecialchars($created_at) . '</p>';
}
if ($updated_at) {
    $html .= '<p><strong>Data actualizării:</strong> ' . htmlspecialchars($updated_at) . '</p>';
}
if ($language) {
    $html .= '<p><strong>Limbă:</strong> ' . htmlspecialchars($language) . '</p>';
}
$html .= '<hr>';
