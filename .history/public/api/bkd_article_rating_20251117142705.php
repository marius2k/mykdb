...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stars !== null) {
        ...
        try {
            ...
            $tracker->trackRating($userId, $articleId, $stars);
        } catch (Exception $e) {
            error_log("Failed to track rating: " . $e->getMessage());
        }
    }
    ...
    if ($wasHelpful !== null) {
        ...
        try {
            $tracker = new AnalyticsTracker();
            $tracker->trackUsefulnessRating($userId, $articleId, $wasHelpful);
        } catch (Exception $e) {
            error_log("Failed to track usefulness rating: " . $e->getMessage());
        }
    }
