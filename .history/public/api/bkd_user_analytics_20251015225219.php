...
/**
 * Overload for trackUserAction when called directly from other API endpoints
 * This function handles the case where trackUserAction is called with data directly
 * rather than getting data from the request
 * 
 * @param array $data Analytics data to track
 * @return bool Success status
 */
function trackUserAction($data) {
    // Handle both ways of calling this function
    if ($data instanceof Database) {
        // This is the original function call pattern where $data is actually the DB connection
        // Call the original function
        return trackUserAction($data);
    }
    ...
    try {
        ...
        error_log("Error in trackUserAction direct call: " . $e->getMessage());
