...
try {
    ...
    // Trimite notificări către userul care a creat articolul
    //sendNotificationToUser($article['created_by'], 'info', 'Article <a href="view_article.php?id=' . $articleId . '">' . truncateText($article['title'], 30) . '</a> has been rejected.');
