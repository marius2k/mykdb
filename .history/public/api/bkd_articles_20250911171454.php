...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    // Apply role-based filtering for contributors - ACTUALIZAT pentru article_versions
    $roleFilter = '';
    $roleParams = [];
    ...
    $params = [];
    if ($searchValue) {
        // ACTUALIZAT pentru article_versions
