            ...
            if (file_exists(APP_ROOT . '/public/api/bkd_user_analytics.php')) {
                ...
                if (function_exists('trackUserActionDirect')) {
                    $analyticsData = [
                        ...
                        'action_type' => 'rating', // Required for tracking
                        'value' => $stars,
                        'action' => 'track_user_action' // Add this to satisfy the switch statement
                    ];
                    trackUserActionDirect($analyticsData);
                }
            }
        } catch (Exception $e) {
            error_log("Error tracking star rating: " . $e->getMessage());
