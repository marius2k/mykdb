 ...
 */
function approveArticle(articleId, publishAt = '', version = null) {
    let body = `action=approve&article_id=${encodeURIComponent(articleId)}&csrf_token=${encodeURIComponent(window.CSRF_TOKEN)}`;
...
// Submit an article for approval (status=pending)
