...
window.formatCategoryWithIconNew = function(option) {
  console.log('=== NEW FUNCTION CALLED ===', option);
  ...
  console.log('Text before truncation:', text, 'Length:', text.length);
  
  // Truncate to 20 characters
  if (text.length > 20) {
    text = text.substring(0, 19) + '…';
    console.log('Text after truncation:', text);
  }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        ...
        console.log('formatWithIcon function exists:', typeof window.formatCategoryWithIconNew);
        ...
        $select.select2({
            ...
            templateResult: function(option) {
                ...
                console.log('About to call formatCategoryWithIconNew');
                const result = window.formatCategoryWithIconNew(option);
                console.log('formatCategoryWithIconNew returned:', result);
                return result;
            },
