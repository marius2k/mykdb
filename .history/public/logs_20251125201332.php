...
<div style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-top: 20px; margin-bottom: 10px;">
    ...
    <!-- Filter on the right -->
    <div id="logs-filters" style="border: 1px solid #ccc; border-radius: 8px; padding: 10px 15px; background-color: #f8f9fa;">
...
function renderFilters(users) {
    ...
    if (showUserFilter) {
        html += `<div style="display: flex; flex-direction: column; gap: 5px;">
            <label style="color: #666; font-size: 12px; margin: 0;"><?= lang('lang_log_filter_user') ?></label>
            <select id="filterUserId" name="user_id" style="padding: 5px 10px; border: 1px solid #ccc; border-radius: 4px; font-size: 14px;">
    ...
    html += `<div style="display: flex; flex-direction: column; gap: 5px;">
            <label for="start_date" style="color: #666; font-size: 12px; margin: 0;"><?= lang('lang_log_filter_start_date') ?? 'De la data' ?></label>
            <input type="datetime-local" id="start_date" name="start_date" style="padding: 5px 10px; border: 1px solid #ccc; border-radius: 4px; font-size: 14px;">
        </div>
        <div style="display: flex; flex-direction: column; gap: 5px;">
            <label for="end_date" style="color: #666; font-size: 12px; margin: 0;"><?= lang('lang_log_filter_end_date') ?? 'Până la data' ?></label>
            <input type="datetime-local" id="end_date" name="end_date" style="padding: 5px 10px; border: 1px solid #ccc; border-radius: 4px; font-size: 14px;">
        </div>
