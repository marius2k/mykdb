...
document.addEventListener('DOMContentLoaded', function() {
    const searchIcon = '🔍';
    const topViewIcon = '<img src="<?= APP_URL ?>assets/icons/icon-top-view.svg" width="25" height="auto">';
    const topLikeIcon = '<img src="<?= APP_URL ?>assets/icons/icon-top-like.svg" width="25" height="auto">';
