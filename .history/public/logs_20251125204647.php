...
<div style="background-color: #e8f4f8; display: flex; justify-content: space-between; align-items: center; width: 100vw; padding: 5px 20px; margin-top: 0; margin-bottom: 0; margin-left: calc(-50vw + 50%); border-bottom: 1px solid #b0d4e3;">
