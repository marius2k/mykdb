...
<link rel="stylesheet" href="<?= APP_URL ?>assets/css/components/DashboardStatsBar.css">
<script crossorigin src="https://unpkg.com/react@18/umd/react.production.min.js"></script>
<script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.production.min.js"></script>
<script src="<?= APP_URL ?>assets/js/react-components-dist/CardInfoBox.js"></script>
<script src="<?= APP_URL ?>assets/js/react-components-dist/DashboardStatsBar.js"></script>
...
$(function() {
    ...
    $.getJSON('api/get_dashboard_stats.php', function(statsData) {
        if (statsData.success) {
            const statsRoot = ReactDOM.createRoot(document.getElementById('dashboard-stats-root'));
            statsRoot.render(
                React.createElement(DashboardStatsBar, {
