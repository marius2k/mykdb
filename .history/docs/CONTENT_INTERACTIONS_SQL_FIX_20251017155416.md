...
The Content Interactions tab in the User Analytics dashboard (`/public/admin/user_analytics.php`) was displaying an empty table for "Top Articles by Interaction". When the user selected a date range and loaded the data, the table showed "No data available" despite having interaction data in the database.
