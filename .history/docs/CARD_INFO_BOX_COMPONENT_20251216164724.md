...
| `defaultOpen` | boolean | `false` | Whether the card is open by default |
...
<CardInfoBox
    ...
    body="<p>This content can be collapsed/expanded using the toggle button.</p>"
    collapsible={true}
    defaultOpen={true}
/>
```
...
<CardInfoBox
    ...
    body="<p>This card cannot be collapsed.</p>"
    collapsible={false}
/>
```
...
<CardInfoBox
    ...
    body="<p>This starts collapsed and can be expanded.</p>"
    defaultOpen={false}
/>
```
...
### Articles Analytics (`public/admin/articles_analytics.php`)
- Top Articles Performance section
- Top Articles Details section

### User Analytics (`public/admin/user_analytics.php`)
- Engagement Over Time chart
- Most Engaged Users table
- Engagement by Role chart

Each section is wrapped in a CardInfoBox component with:
- Appropriate icon from `/assets/icons/`
- Translated title with filter information
- Chart.js canvas or DataTable as body content
- Collapsed by default (`defaultOpen: false`)
- 100ms setTimeout for Chart.js initialization to wait for React mounting
