...
1. **Query Volume**
   ...
   - **Data Collection**: Automatically tracked whenever a user performs a search
   - **Data Source**: `search_queries` table, count of entries by query
...
2. **Search-to-Click Ratio**
   ...
   - **Data Collection**: Comparison between search events and search click events
   - **Data Source**: Join of `search_queries` and `search_results_clicks` tables
...
3. **Zero-Result Searches**
   ...
   - **Data Collection**: Automatically tracked in the results_count field
   - **Data Source**: `search_queries` table where results_count = 0
...
4. **Search Result Position Clicks**
   ...
   - **Data Collection**: Position is recorded when a user clicks a search result
   - **Data Source**: `search_results_clicks` table, position field
...
1. **Download Frequency**
   ...
   - **Data Collection**: Automatically tracked whenever a PDF is downloaded
   - **Data Source**: `file_downloads` table, count of entries by article_id
...
2. **User Segments**
   ...
   - **Data Collection**: User ID is recorded with each download
   - **Data Source**: Join `file_downloads` with `users` table
...
3. **Time-of-Day Patterns**
   ...
   - **Data Collection**: Timestamp is recorded with each download
   - **Data Source**: `file_downloads` table, download_date field, hour extraction
