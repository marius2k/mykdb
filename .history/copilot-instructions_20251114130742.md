...
-> the defined operations on a version of an article are: view, edit, view history, approve, publish, disable, restore, delete;
-> view - the version could be viewd in all its statuses;
