...
function renderNotifications(array $notifications,array $t ): string {
    ...
    if (empty($notifications)) {
        $bodyContent = '<div style="color: #888; padding: 20px;">' . $t['lang_db_no_notif'] . '</div>';
    } else {
        // Generate the notifications table
        $bodyContent = '<table width="100%" style="border-collapse: collapse;">
                            <thead>
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <th style="padding: 8px; text-align: left;">'.$t['lang_db_notif_type'].'</th>
                                    <th style="padding: 8px; text-align: left;">'.$t['lang_db_notif_message'].'</th>
                                    <th style="padding: 8px; text-align: left;">'.$t['lang_db_notif_date'].'</th>
                                    <th style="padding: 8px; width: 70px; text-align: center;">'.$t['lang_db_notif_actions'].'</th>
                                </tr>
                            </thead>
                            <tbody>';
        ...
        foreach ($notifications as $n) {
            ...
            $bodyContent .= '<tr id="notif-' . $n['id'] . '" style="color: ' . $color . '; font-size: 12px; border-bottom: 1px solid #e9ecef;" >
                        ...
                        <td style="padding: 8px; width: 70px; text-align: center;">';
        ...
        (function() {
            ...
            root.render(
                React.createElement(CardInfoBox, {
                    icon: "' . APP_URL . 'assets/icons/icon-notification.svg",
