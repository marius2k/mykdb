...
function generateNavBar2($uid) {
    ...
    if(hasPermission($uid,$ops)){
        $adminMenuItems .= '<div class="dropdown-submenu">
            <a class="dropdown-item dropdown-toggle admin-submenu-trigger" href="#" onclick="toggleSubmenu(event, \'users-submenu\'); return false;">
    ...
    if (hasPermission($uid,$ops)){
        $adminMenuItems .= '<div class="dropdown-submenu">
            <a class="dropdown-item dropdown-toggle admin-submenu-trigger" href="#" onclick="toggleSubmenu(event, \'categories-submenu\'); return false;">
    ...
    if (hasPermission($uid,$ops)){
        $adminMenuItems .= '<div class="dropdown-submenu">
            <a class="dropdown-item dropdown-toggle admin-submenu-trigger" href="#" onclick="toggleSubmenu(event, \'articles-submenu\'); return false;">
    ...
    if (hasPermission($uid,$ops)){
        $adminMenuItems .= '<div class="dropdown-submenu">
            <a class="dropdown-item dropdown-toggle admin-submenu-trigger" href="#" onclick="toggleSubmenu(event, \'tags-submenu\'); return false;">
