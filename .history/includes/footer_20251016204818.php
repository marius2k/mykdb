...
<?php
// Include search analytics on pages with search functionality
$current_page = basename($_SERVER['PHP_SELF']);
$search_pages = ['index.php', 'dashboard.php', 'articles_by_tag.php'];

if (in_array($current_page, $search_pages) || isset($_GET['search']) || isset($_GET['q'])):
?>
<script src="<?= APP_URL ?>assets/js/search-analytics.js"></script>
<?php endif; ?>

<?php
// Include PDF tracking on article view pages
$article_pages = ['view_article.php', 'edit_article.php'];

if (in_array($current_page, $article_pages) || isset($_GET['id'])):
?>
<script src="<?= APP_URL ?>assets/js/pdf-tracker.js"></script>
<?php endif; ?>
</body>
</html>