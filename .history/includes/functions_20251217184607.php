                ...
                (function() {
                    ...
                    root.render(
                        React.createElement(CardInfoBox, {
                            ...
                            body: React.createElement("div", {
                                style: { padding: "10px", width: "100%", maxWidth: "400px", height: "auto", position: "relative", margin: "0 auto" },
                                dangerouslySetInnerHTML: { __html: \'<canvas id="commentsChart" width="400" height="130"></canvas>\' }
                            }),
                            collapsible: true,
                            defaultOpen: true,
                            titleSize: "1.1em",
