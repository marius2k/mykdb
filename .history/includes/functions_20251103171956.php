...
function generateNavBar2($uid) {
        ...
        $adminMenuItems .= '<div class="dropdown-submenu">
            ...
            <div class="dropdown-menu analytics-submenu">
                <a href="'.APP_URL.'public/admin/user_analytics.php" class="dropdown-item">
                    <img src="'.APP_URL.'assets/icons/icon-user-analytics.svg" class="submenu-icon"> Users
                </a>
                <a href="'.APP_URL.'public/admin/articles_analytics.php" class="dropdown-item">
                    <img src="'.APP_URL.'assets/icons/icon-analytics.svg" class="submenu-icon"> Articles
                </a>
                <a href="'.APP_URL.'public/admin/search_analytics.php" class="dropdown-item">
                    <img src="'.APP_URL.'assets/icons/icon-view.svg" class="submenu-icon"> Search
                </a>
            </div>
        </div>';
        $hasAdminAccess = true;
    ...
    if ($hasAdminAccess) {
        $isAdminPageActive = in_array($currentPage, ['logs.php', 'users.php', 'categories.php', 'articles.php', 'articles_analytics.php', 'user_analytics.php', 'search_analytics.php', 'tags.php', 'comments.php', 'acl_edit.php']);
